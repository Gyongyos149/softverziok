...
@Component({
  selector: 'app-verziok',
  standalone: true,
  imports: [],
  templateUrl: './verziok.component.html',
  styleUrl: './verziok.component.css'
})
export class VerziokComponent {
 ...
 szoftverVerziok = [
  ...
  ngOnInit() {
    ...
    for(let i=0; i<this.szoftverVerziok.length; i++) {
      this.ossz_hiba = this.ossz_hiba + this.szoftverVerziok[i].hibak
    }
  }
}
